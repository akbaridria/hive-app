    ...
    writeContract(
      {
        ...
        args: [[price * 10 ** quoteDecimal], [amount * 10 ** baseDecimal], [0]],
      },
      {
        onSuccess: (hash) => {
          setTxHash(hash);
  ...
  return (
    <div className="relative pl-10 pb-12 last:pb-0">
      ...
      <div className="space-y-3">
        <div>
          <h3 className="text-base font-medium">Place Buy Limit Order</h3>
        </div>
        <p className="text-sm text-muted-foreground">
          Place a buy limit order on the order book, specifying the price and
