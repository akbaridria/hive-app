...
const SubmitTransaction: React.FC<SubmitTransactionProps> = ({
  ...
  }, [amount, prices, quoteDecimal, pairAddress, writeContract]);
  ...
  return (
    <div className="relative pl-10 pb-12 last:pb-0">
      ...
      <div className="space-y-3">
        <div>
          <h3 className="text-base font-medium">Place Buy Market Order</h3>
        </div>
        <p className="text-sm text-muted-foreground">
          Place a buy market order on the order book, specifying the price and
